      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <p>Level 0 completed</p>
          <p>Level 1 Compelted</p>
          <p>Level 2 Completed</p>
          <p><span class="w3-tag w3-wide">Level 3</span></p>
          <p>Level 3 ---> Level 4</p>
          <p>Level 4 ---> Level 5</p>
          <p>Level 5 ---> Level 6</p>
          <p>Level 6 ---> Level 7</p>
...
<div class="w3-col m7" id="about">
  ...
  <div class="w3-content" style="max-width:650px">
    ...
    <h4 class="w3-center w3-padding-60"><marquee><span class="w3-tag w3-wide">Congradulations! Now you are in - Level 3</span></marquee></h4>
    <p>Meanwhile Dustin, Mike and Lucas come to find Will without anyone’s permission and find Eleven instead of Will from the woods and provide her sanctuary in Mike’s basement secretly and provide foods and other basic needs for living by concealing Eleven from the outside world. In this case just like Will’s friends did.
 </p>
    <p></p>
    <div class="w3-panel w3-leftbar w3-light-grey">
      <p><strong>User Name:</strong>Level3</p>
    <p><strong>Password:</strong></p>
    </div>
    <img src="https://i.giphy.com/media/l1J9wZJLPywQuKovK/giphy.webp" style="width:100%;max-width:1000px" class="w3-margin-top">
...
<div class="w3-col m2" id="where" style="padding-bottom:32px;">
   <h5 class="w3-right w3-padding-44"><span class="w3-tag w3-wide">Score : 5</span></h5>
