      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <p>Level 0 completed</p>
          ...
          <p><span class="w3-tag w3-wide">Level 2</span></p>
          <p>Level 2 ---> Level 3</p>
          <p>Level 3 ---> Level 4</p>
          <p>Level 4 ---> Level 5</p>
          <p>Level 5 ---> Level 6</p>
...
<div class="w3-col m7" id="about">
  ...
  <div class="w3-content" style="max-width:650px">
    ...
    <h4 class="w3-center w3-padding-60"><marquee><span class="w3-tag w3-wide">Congradulations! Now you are in - Level 2</span></marquee></h4>
    <p> The girl called Eleven with psychokinetic abilities escapes from the Hawkins lab and run to the woods while government agents are chasing after Eleven. </p>
    <p></p>
    <div class="w3-panel w3-leftbar w3-light-grey">
      <p><strong>User Name:</strong>Level2</p>
    <p><strong>Password:</strong></p>
    </div>
    <img src="https://i.pinimg.com/originals/26/38/8f/26388fc7edc935125267a0d6d41b5349.gif" style="width:100%;max-width:1000px" class="w3-margin-top">
...
<div class="w3-col m2" id="where" style="padding-bottom:32px;">
   <h5 class="w3-right w3-padding-44"><span class="w3-tag w3-wide">Score : 3</span></h5>
