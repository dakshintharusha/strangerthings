      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <p>Level 0 completed</p>
          ...
          <p><span class="w3-tag w3-wide">Level 5</span></p>
          <p>Level 5 ---> Level 6</p>
          <p>Level 6 ---> Level 7</p>
          <p>Level 7 ---> Level 8</p>
          <p>Level 8 ---> Level 9</p>
...
<div class="w3-col m7" id="about">
  ...
  <div class="w3-content" style="max-width:650px">
    ...
    <h4 class="w3-center w3-padding-60"><marquee><span class="w3-tag w3-wide">Congradulations! Now you are in - Level 5</span></marquee></h4>
    <p>Then Joyce Byers notice abnormal blinks of Christmas lights and finds out that was Will trying to connect with her. Somehow Will blinks Christmas lights corresponding to letters of the alphabet and starts to communicate with mom from the upside down. 
 </p>
    <p></p>
    <div class="w3-panel w3-leftbar w3-light-grey">
      <p><strong>User Name:</strong>Level5</p>
    <p><strong>Password:</strong></p>
    </div>
    <img src="https://data.whicdn.com/images/274761407/original.gif" style="width:100%;max-width:1000px" class="w3-margin-top">
  </div>
</div>
...
<div class="w3-col m2" id="where" style="padding-bottom:32px;">
   <h5 class="w3-right w3-padding-44"><span class="w3-tag w3-wide">Score : 10</span></h5>
