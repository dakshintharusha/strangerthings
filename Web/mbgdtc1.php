      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <p>Level 0 completed</p>
          <p><span class="w3-tag w3-wide">Level 1</span></p>
          <p>Level 1 ---> Level 2</p>
          <p>Level 2 ---> Level 3</p>
          <p>Level 3 ---> Level 4</p>
          <p>Level 4 ---> Level 5</p>
...
<div class="w3-col m7" id="about">
  ...
  <div class="w3-content" style="max-width:650px">
    ...
    <h4 class="w3-center w3-padding-60"><marquee><span class="w3-tag w3-wide">Congradulations! Now you are in - Level 1</span></marquee></h4>
    <p>The investigation begins from this level. After disappearing Will his family, friends and other villagers including Jim Hopper Chief police officer start finding Will. 
 </p>
    <p>As the first clue, Jim finds Will’s bike and so as that the player needs to find the password and username for the next level.</p>
    <div class="w3-panel w3-leftbar w3-light-grey">
      <p><strong>User Name:</strong>Level1</p>
    <p><strong>Password:</strong></p>
    </div>
    <img src="https://64.media.tumblr.com/fc0993f654e1cedc4f28c6e03946f189/tumblr_ouwrlbqgak1s40634o4_540.gif" style="width:100%;max-width:1000px" class="w3-margin-top">
...
<div class="w3-col m2" id="where" style="padding-bottom:32px;">
   <h5 class="w3-right w3-padding-44"><span class="w3-tag w3-wide">Score : 2</span></h5>
