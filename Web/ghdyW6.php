 	...
 	<div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <p>Level 0 completed</p>
          ...
          <p>Level 5 completed</p>
          <p><span class="w3-tag w3-wide">Level 6</span></p>
          <p>Level 6 ---> Level 7</p>
          <p>Level 7 ---> Level 8</p>
          <p>Level 8 ---> Level 9</p>
...
<div class="w3-col m7" id="about">
  ...
  <div class="w3-content" style="max-width:650px">
    ...
    <h4 class="w3-center w3-padding-60"><marquee><span class="w3-tag w3-wide">Congradulations! Now you are in - Level 6</span></marquee></h4>
    <p>Joyce Byers communicates and finds the Will with the help of Eleven. For that as usually Dustin, Mike and Lucas help to Will’s mom and Jim Hopper also engaged with them. Then Demogorgon returns from the upside down to children’s school and Eleven defeats it using her superpowers and gets stuck in the upside down. 
 </p>
    <p></p>
    <div class="w3-panel w3-leftbar w3-light-grey">
      <p><strong>User Name:</strong>Level6</p>
    <p><strong>Password:</strong></p>
    </div>
    <img src="https://media1.popsugar-assets.com/files/thumbor/-9en1U3T5BX8Ep6rhW8GJHCt1wI/fit-in/2048xorig/filters:format_auto-!!-:strip_icc-!!-/2017/10/27/151/n/41306527/tmp_AhZZ4t_5c22486adf530c07_eleven.gif" style="width:100%;max-width:1000px" class="w3-margin-top">
   </div>
</div>


<div class="w3-col m2" id="where" style="padding-bottom:32px;">
   <h5 class="w3-right w3-padding-44"><span class="w3-tag w3-wide">Score : 13</span></h5>
